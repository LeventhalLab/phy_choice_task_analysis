...
%     [eventTimes, ii] = sort(eventTimes);   this section checks if
%     'eventTimes is sorted in ascending order, if not it sorts it but also
%     makes sure that the timestamp is still attached to the correct unit
