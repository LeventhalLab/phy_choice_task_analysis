...
addpath(genpath('GitHub\intan_fileio'))
addpath(genpath('GitHub\ChoiceTask_Intan\ChoiceTask_Intan_behavior_analysis'))
addpath(genpath('GitHub\LeventhalWorkflow\ChoiceRTBehavior'))
addpath 'X:\Neuro-Leventhal\data\ChoiceTask'\R0494\R0494-rawdata\R0494_20231127d'' % Needed to run readLogData, should generalize later
addpath 'H:\KK-GitHub\'
tic;
...
addpath 'X:\Neuro-Leventhal\data\ChoiceTask\GitHub\ChoiceTask_Intan\ChoiceTask_Intan_behavior_analysis'
...
logData = readLogData('R0493_20230718_17-03-14.log'); 
